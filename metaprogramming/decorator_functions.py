...
Decorator Functions
    ...
    Expects only one argument - the function to be modified
    ...
    The wraps decorator form the functools module in the standard library should be used with the function that returns the replacment function
    This makes sure the replacement function keeps the same properties (especially the name) as the original (target) function.
    Syntax
        @decorator
        def function():
            pass
